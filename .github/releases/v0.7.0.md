...
- Records the **Provider Credential Pool** glossary term and ADR-0005.
- Skill and README language describes multi-credential load spreading and rate-limit rotation.
