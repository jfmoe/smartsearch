...
For new installations, use [forager](https://github.com/jfmoe/forager):

```powershell
npx skills add jfmoe/forager
```

The commands below install the retired Python implementation and are retained only for historical
recovery.
...
`@jfmoe/smart-search@0.7.2` is the final personal distribution release. Node is the only
